...
Flutter Android app for remote monitoring and control of the AgriPulse ESP32 system.
...
Download the latest APK from [GitHub Releases](https://github.com/nperiannan/AgriPulse/releases) (tag prefix `pulse-app/`).
